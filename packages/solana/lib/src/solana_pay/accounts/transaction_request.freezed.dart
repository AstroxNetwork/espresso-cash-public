...
mixin _$TransactionRequestInfo {
  ...
  $TransactionRequestInfoCopyWith<TransactionRequestInfo> get copyWith =>
      _$TransactionRequestInfoCopyWithImpl<TransactionRequestInfo>(
          this as TransactionRequestInfo, _$identity);
...
class _TransactionRequestInfo implements TransactionRequestInfo {
  ...
  _$TransactionRequestInfoCopyWith<_TransactionRequestInfo> get copyWith =>
      __$TransactionRequestInfoCopyWithImpl<_TransactionRequestInfo>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TransactionRequestInfoToJson(
      this,
    );
  }
...
abstract mixin class _$TransactionRequestInfoCopyWith<$Res>
    implements $TransactionRequestInfoCopyWith<$Res> {
  factory _$TransactionRequestInfoCopyWith(_TransactionRequestInfo value,
  ...
  $TransactionRequestResponseCopyWith<TransactionRequestResponse>
      get copyWith =>
          _$TransactionRequestResponseCopyWithImpl<TransactionRequestResponse>(
              this as TransactionRequestResponse, _$identity);
...
class _TransactionRequestResponse implements TransactionRequestResponse {
  const _TransactionRequestResponse(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TransactionRequestResponseCopyWith<_TransactionRequestResponse>
      get copyWith => __$TransactionRequestResponseCopyWithImpl<
          _TransactionRequestResponse>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TransactionRequestResponseToJson(
      this,
    );
  }
