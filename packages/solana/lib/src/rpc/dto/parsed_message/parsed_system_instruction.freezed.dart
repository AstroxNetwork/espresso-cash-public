...
mixin _$ParsedSystemInstruction {
  ...
  $ParsedSystemInstructionCopyWith<ParsedSystemInstruction> get copyWith =>
      _$ParsedSystemInstructionCopyWithImpl<ParsedSystemInstruction>(
          this as ParsedSystemInstruction, _$identity);
...
/// @nodoc
@JsonSerializable()
class ParsedSystemTransferCheckedInstruction
    implements ParsedSystemInstruction {
  const ParsedSystemTransferCheckedInstruction(
      {required this.info, required this.type});
...
mixin _$ParsedSystemTransferInformation {
  ...
  $ParsedSystemTransferInformationCopyWith<ParsedSystemTransferInformation>
      get copyWith => _$ParsedSystemTransferInformationCopyWithImpl<
              ParsedSystemTransferInformation>(
          this as ParsedSystemTransferInformation, _$identity);
...
class _ParsedSystemTransferInformation
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$ParsedSystemTransferInformationToJson(
      this,
    );
  }
