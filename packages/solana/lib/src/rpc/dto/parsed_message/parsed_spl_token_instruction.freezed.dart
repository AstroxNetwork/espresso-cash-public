...
mixin _$ParsedSplTokenInstruction {
  ...
  $ParsedSplTokenInstructionCopyWith<ParsedSplTokenInstruction> get copyWith =>
      _$ParsedSplTokenInstructionCopyWithImpl<ParsedSplTokenInstruction>(
          this as ParsedSplTokenInstruction, _$identity);
...
class ParsedSplTokenTransferInstruction implements ParsedSplTokenInstruction {
  const ParsedSplTokenTransferInstruction(
...
/// @nodoc
@JsonSerializable()
class ParsedSplTokenTransferCheckedInstruction
    implements ParsedSplTokenInstruction {
  const ParsedSplTokenTransferCheckedInstruction(
      {required this.info, required this.type});
...
class ParsedSplTokenGenericInstruction implements ParsedSplTokenInstruction {
  const ParsedSplTokenGenericInstruction(
      {required this.info, required this.type});
  factory ParsedSplTokenGenericInstruction.fromJson(
          Map<String, dynamic> json) =>
