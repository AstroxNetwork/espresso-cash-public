...
class $ParsedAccountDataCopyWith<$Res> {
  $ParsedAccountDataCopyWith(
      ParsedAccountData _, $Res Function(ParsedAccountData) __);
}
...
class ParsedSplToken2022ProgramAccountData implements ParsedAccountData {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ParsedSplToken2022ProgramAccountDataCopyWith<
          ParsedSplToken2022ProgramAccountData>
      get copyWith => _$ParsedSplToken2022ProgramAccountDataCopyWithImpl<
          ParsedSplToken2022ProgramAccountData>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ParsedSplToken2022ProgramAccountDataToJson(
      this,
    );
  }
...
class UnsupportedProgramAccountData implements ParsedAccountData {
  const UnsupportedProgramAccountData(final Map<String, dynamic> parsed,
      {final String? $type})
      : _parsed = parsed,
