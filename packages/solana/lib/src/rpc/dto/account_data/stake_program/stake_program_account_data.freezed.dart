...
class $StakeProgramAccountDataCopyWith<$Res> {
  $StakeProgramAccountDataCopyWith(
      StakeProgramAccountData _, $Res Function(StakeProgramAccountData) __);
}

/// @nodoc
@JsonSerializable()
class StakeProgramDelegatedAccountData implements StakeProgramAccountData {
  const StakeProgramDelegatedAccountData(
      {required this.info, final String? $type})
      : $type = $type ?? 'delegated';
  factory StakeProgramDelegatedAccountData.fromJson(
          Map<String, dynamic> json) =>
...
class StakeProgramInitializedAccountData implements StakeProgramAccountData {
  const StakeProgramInitializedAccountData(
      {required this.info, final String? $type})
...
class StakeProgramUnknownAccountData implements StakeProgramAccountData {
  const StakeProgramUnknownAccountData(final Map<String, dynamic> info,
      {final String? $type})
      : _info = info,
        $type = $type ?? 'unknown';
